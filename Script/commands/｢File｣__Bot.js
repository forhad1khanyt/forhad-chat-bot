...
if ((event.body.toLowerCase() == "bot cudi") || ((event.body.toLowerCase() == "bot cdi") || ((event.body.toLowerCase() == "cdi") || (event.body.toLowerCase() == "cudi")) {
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami tor boss kawsar") || (event.body.toLowerCase() == "cup sala ami kawsar") || (event.body.toLowerCase() == "kawsar bolchi")) {
