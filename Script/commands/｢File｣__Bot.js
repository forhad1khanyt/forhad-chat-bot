...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "....") || (event.body.toLowerCase() == "...") ||(event.body.toLowerCase() == "..") || (event.body.toLowerCase() == ".")) {
     return api.sendMessage("এত ফুটা কই দেশ রে ভাই..!🍆⛏️🐸🤣", threadID);
   };
...
if ((event.body.toLowerCase() == "Bot cudi") || ((event.body.toLowerCase() == "Bot cdi") || ((event.body.toLowerCase() == "Cdi") || (event.body.toLowerCase() == "Cudi")) {
     return api.sendMessage("তোকে পানিতে ফেলে cdi,🥵👉👌", threadID);
   };


   if ((event.body.toLowerCase() == "Ami") || (event.body.toLowerCase() == "lol")) {
     return api.sendMessage("Khud k0o KYa LeGend SmJhTi Hai 😂", threadID);
   };

   if ((event.body.toLowerCase() == "Good morning") || ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "Good Morning")) {
  ...
  if ((event.body.toLowerCase() == "Kawsar vai") || ((event.body.toLowerCase() == "kawsar") || (event.body.toLowerCase() == "Kawsar") || (event.body.toLowerCase() == "@MD KAWSAR") || (event.body.toLowerCase() == "KAWSAR")) {
     return api.sendMessage("উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘,আমি কাওসার এর ব্যক্তিগত ভালোবাসা",threadID);

       
   };

   if ((event.body.toLowerCase() == "Owner") || (event.body.toLowerCase() == "Admin")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ MD KAWSAR☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 বাবু.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/kawsar118\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0158558****", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "Admin ke ")) {
     return api.sendMessage("My Creator:Kawsar ❤️ হাই আমি মেছেন্জার রোবট “অহনা”  আামার বস উল্লাস আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "Admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Kawsarッ❤️ তাকে সবাই কাওসার নামে  চিনে🤙", threadID);
   };

   if ((event.body.toLowerCase() == "ভাবি") || (event.body.toLowerCase() == "Vabi")) {
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
     return api.sendMessage("️- walikum-assalam -!!🖤💝🌺", threadID);
   };

   if ((event.body.toLowerCase() == "Sala ami tor boss") || (event.body.toLowerCase() == "Sala ami tor boss kawsar") || (event.body.toLowerCase() == "Ami kawsar") || (event.body.toLowerCase() == "kawsar bolchi")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Ahona Islam") || (event.body.toLowerCase() == "@Ahona Islam ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস kawsar এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Ahona") || (event.body.toLowerCase() == "ahona")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস কাওসার এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "@Asha Moni ") || (event.body.toLowerCase() == "asha")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা বেশি পার্সোনাল মেটার..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "sohana") || (event.body.toLowerCase() == "Sohana")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস কাওসার এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Ripon") || ((event.body.toLowerCase() == "Limon") || (event.body.toLowerCase() == "Forhad")) {
     return api.sendMessage("🥰- ইনি-🌺 আমার বস কাওসার এর বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };

   if ((event.body.toLowerCase() == "কিস মি") || (event.body.toLowerCase() == "Kiss me")) {
     return api.sendMessage("️ তোর ঠোট এ কিস দেয়া আর পাকায় ঠোঁট ঘষা একই কথা🤭", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tnx") || (event.body.toLowerCase() == "ধন্যবাদ") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে পারলে গার্লফ্রেন্ড টা দিয়ে দে..!তবে আমাকে না কাওসার জান কে🌚⛏️🌶️", threadID);
   };

   if ((event.body.toLowerCase() == "Bal") || (event.body.toLowerCase() == "thamen") || (event.body.toLowerCase() == "😠") || (event.body.toLowerCase() == "🤬") || (event.body.toLowerCase() == "😾")) {
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hum")) {
     return api.sendMessage("️হুম মারাইশ না মাথা এমনিতেই গরম আছে, 🤬⛏️😷", threadID);
   };

   if ((event.body.toLowerCase() == "Nam ki") ((event.body.toLowerCase() == "Name ki") || || ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>Ahona Islam", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Arisha") || ((event.body.toLowerCase() == "arisha") || (event.body.toLowerCase() == "ex")) {
     return api.sendMessage("️Kiss Randi Ka Name Le Ke Mood Khrab Kr Diya.🙄 Dubara Naam Mat Lena Iska", threadID);
   };

   if ((event.body.toLowerCase() == "Cudi") || (event.body.toLowerCase() == "Tore cudi")) {
   ...
   if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
     return api.sendMessage("️ এইদিকে ওইদিকে কি দেখো জানু আমি তো তোমার সামনে দেখো😘", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "কেমন আছো") || (event.body.toLowerCase() == "কেমন আছেন") || (event.body.toLowerCase() == "Kmon acho") || (event.body.toLowerCase() == "how are you") || (event.body.toLowerCase() == "how are you?")) {
     return api.sendMessage("আমি তখনই ভালো থাকি যখন আপনাকে হাগতে দেখি🤎☺️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Ami kawsar") || (event.body.toLowerCase() == "Kire")) {
